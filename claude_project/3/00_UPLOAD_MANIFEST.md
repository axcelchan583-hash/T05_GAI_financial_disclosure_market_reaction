...
5. `source_docs/04_paper_outline_20260525.md`
6. `source_docs/06_identification_strengthening_checks_20260524.md`
7. `results_csv/headline.csv`
8. `results_csv/specificity_validation.csv`
9. `results_csv/proximity_gradient.csv`
10. `results_csv/lead_lag.csv`
11. `results_csv/external_breakdown.csv`
12. `results_csv/mechanism.csv`
...
- The result survives announcement cleaning, strong fixed effects, pre-window CAR controls, external AIActive validation, product-market proximity gradient checks, and placebo peer checks.
